<!--
 Copyright (C) 2022 IrisPixel. All rights reserved.
...
<style lang="scss">
	...
	@function text_color($color-name) {
		@if $color-name == 'primary' {
			@return hsl(var(--ip-primary-text-h, 251), var(--ip-primary-text-s, 86%), var(--ip-primary-text-l, 100%));
	...
	@function theme_color($color-name) {
		@if $color-name == 'primary' {
			...
			@return hsl(
				var(--ip-secondary-h, calc(var(--ip-primary-h, 251) + 180)),
				var(--ip-secondary-s, var(--ip-primary-s, 86%)),
				var(--ip-secondary-l, var(--ip-primary-l, 60%))
			);
		} @else {
			@return hsl(var(--ip-primary-h, 251), var(--ip-primary-s, 86%), var(--ip-primary-l, 60%));
		}
	...
	@function darken_theme_color($color-name) {
		@if $color-name == 'primary' {
			...
			@return hsl(
				calc(var(--ip-secondary-h, 251) + 180),
				var(--ip-secondary-s, 90%),
				calc(var(--ip-secondary-l, 63%) - var(--ip-secondary-darken, 20%))
			);
		} @else {
			@return hsl(
				var(--ip-primary-h, 251),
